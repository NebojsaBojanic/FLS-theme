...
================================================== -->
		...
		<section class="offer <?php if($pattern){echo $patternColor; } echo " ".$sectionBgColor; ?>"><!-- start offer -->
...
================================================== -->
		...
		<section class="news <?php if($pattern){echo $patternColor; } echo " ".$sectionBgColor; ?>"><!-- start list -->
			<div class="grid-1160">
							...
							<div><!-- cross browser padding -->
								...
								<div class="newsDescription grid-55 fl"><!-- start newsDescription -->
									...
									<div><!-- start cross browser padding -->
										...
										<h3><?php the_title(); ?></h3>
										<span class="newsCategory text-light-grey">by <?php echo $full_name; ?></span>
...
================================================== -->
		...
		<section class="offer <?php if($pattern){echo $patternColor; } echo " ".$sectionBgColor; ?>"><!-- start list -->
