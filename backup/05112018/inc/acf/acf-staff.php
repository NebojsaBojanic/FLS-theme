...
<!-- start acf-team -->
<section class="acf-block acf-team <?php if($pattern){echo $patternColor; } echo " ".$bgcolor; ?>">
	...
	<div class="grid-1160">
		...
		<?php if ($ourTeamLink) { ?>
			<div class="permalink">
				<a href="<?php echo $ourTeamLink; ?>" class="fls-button <?php if ($buttonBg) { echo $buttonBg; } else { echo $defButtonBg; } ?>" title="Load more employees">
