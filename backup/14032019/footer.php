		...
		<footer class="<?php if($pattern){echo $patternColor; } echo " ".$bgcolor; ?>">
			...
			<?php if($footerContent && in_array('contact_info', $footerContent) ): ?>
				...
				<div class="footer-column"><!-- start footer-column -->
					...
					<div class="footer-column-content">
						...
						<address>
							...
							<?php while(the_flexible_field("contact_information", "option")): 
								if(get_row_layout() == "schulname"):
					// layout: Schulname ?>
									<div class="table-row">
										<!-- <div class="table-cell table-cell-h">Stadt</div> -->
										<div class="table-cell"><?php the_sub_field('schulname', 'option'); ?></div>
									</div>

								<?php elseif(get_row_layout() == "street"): 
					// layout: Street ?>
									<div class="table-row">
										<!-- <div class="table-cell table-cell-h">Straße</div> -->
					...
					// layout: State ?>
									<div class="table-row">
										<!-- <div class="table-cell table-cell-h">Zustand</div> -->
					...
					// layout: Phone ?>
									<div class="table-row">
										<!-- <div class="table-cell table-cell-h">Telefon</div> -->
							...
							<ul>
								...
								<li>
									<?php if ($socialMedia == 'facebook') : ?>
										<a href="<?php the_sub_field('facebook_link', 'option'); ?>" title="Besuchen Sie unser Facebook" target="_blank">
											<img src="<?php echo get_template_directory_uri(); ?>/images/Facebook_icon.png">
										</a>

									<?php elseif ($socialMedia == 'twitter') : ?>
										<a href="<?php the_sub_field('twitter_link', 'option'); ?>" title="Besuchen Sie unser Twitter" target="_blank">
											<img src="<?php echo get_template_directory_uri(); ?>/images/Twitter_icon.png">
										</a>

									<?php elseif ($socialMedia == 'linkedin') : ?>
										<a href="<?php the_sub_field('linkedin_link', 'option'); ?>" title="Besuchen Sie unser LinkedIn" target="_blank">
											<img src="<?php echo get_template_directory_uri(); ?>/images/Linkedin_icon.png">
										</a>

									<?php elseif ($socialMedia == 'instagram') : ?>
										<a href="<?php the_sub_field('instagram_link', 'option'); ?>" title="Besuchen Sie unser Instagram" target="_blank">
			...
			<div class="copy">
				<small><?php the_field('starting_year', 'option'); ?> - <?php echo date("Y"); ?> (&copy;) <?php the_field('footer_copyrights_text', 'option'); ?> <?php if($impressum){ ?><a href="<?php echo $impressum; ?>">(Impressum)</a><?php } ?> - All rights reserved</small>
			</div>
