...
<?php
	...
	$ogTitleDef	= get_field('og_title', 'option');
	// Open Graph description
	$ogDesc 	= get_field('og_description');
	$ogDescDef 	= get_field('og_description', 'option');
	// Open Graph image
	$ogImage 	= '';
...
?>
    ...
    <meta property="og:title" content="<?php if ($ogTitle) {echo $ogTitle;} elseif ($ogTitleDef) {echo $ogTitleDef;} else {the_title();} ?>"/>
    <meta property="og:description" content="<?php if ($ogDesc) {echo $ogDesc;} else {echo $ogDescDef;}?>"/>
...
=============================================================================- -->
		<header class="other-header">
			...
			<div class="fixedMenu"><!-- start stickyMenu -->
