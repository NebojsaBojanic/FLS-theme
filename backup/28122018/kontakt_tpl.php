						...
						<?php if( have_rows('addresses') ): ?>
							...
							$city 		= get_sub_field('city'); ?>
								...
								<p class="contact-info">
									<span><?php echo $street; ?></span><span><?php echo $number; ?></span><br>
									<span><?php echo $postCode; ?></span><span><?php echo $city; ?></span>
								</p>
					...
					<div class="table-cell">
						...
						<?php if( have_rows('emails') ): ?>
							...
							$email 	= get_sub_field('email'); ?>
								...
								<p class="contact-info contact-email"><a class="<?php if ($titleColor) { echo $titleColor; } else { echo $defTitleColor; } ?>" href="mailto:<?php echo $email; ?>" title="Send mail to <?php echo $email; ?>"><?php echo $email; ?></a></p>
					...
					<div class="table-cell">
						...
						<?php if( have_rows('fax_numbers') ): ?>
							...
							$faxNumber 		= get_sub_field('fax_number'); ?>
								...
								<p class="contact-info"><a href="tel:<?php echo $onlyNumber; ?>" title="Call this number"><?php echo $faxNumber; ?></a></p>
					...
					<div class="table-cell">
						...
						<?php if( have_rows('phone_numbers') ): ?>
							...
							$phoneNumber 	= get_sub_field('phone_number'); ?>
								...
								<p class="contact-info"><a href="tel:<?php echo $onlyNumber; ?>" title="Call this number"><?php echo $phoneNumber; ?></a></p>
